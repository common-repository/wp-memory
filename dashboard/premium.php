...
if (!function_exists('ini_set')) {
    ...
    echo '<br />';
    echo esc_attr__("Wizard available to assist you!","wp-memory");
    echo '<br />';
    echo esc_attr__("Dedicated support website.","wp-memory");
    echo '<br />';
    echo esc_attr__("Lifetime Access (One-Time Payment). Affordable Price!","wp-memory");
    echo '<br />';
    echo esc_attr__("Solve your problem now! Download instantly and get up and running in minutes.");
    echo '<br />';
    echo '</p>' . "\n";
    echo '<br />';
