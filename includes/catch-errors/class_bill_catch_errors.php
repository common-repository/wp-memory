<?php namespace wpmemory_BillCatchErrors;
// created 06/23/23
...
add_action("wp_ajax_bill_minozzi_js_error_catched", "wpmemory_BillCatchErrors\\bill_minozzi_js_error_catched");
add_action("wp_ajax_nopriv_bill_minozzi_js_error_catched", "wpmemory_BillCatchErrors\\bill_minozzi_js_error_catched");
    ...
    if (isset($_REQUEST)) {
        ...
        foreach ($errors as $error) {
            ...
            if($log_error) {
                ...
                if($wpmemory_plugin_slug  == 'wptools')
