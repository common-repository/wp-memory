<?php // namespace wpmemory_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class wpmemory_Bill_Minozzi_Add_Ajax_Url
{
...
$wpmemory_bill_minozzi_add_ajax_url = new wpmemory_Bill_Minozzi_Add_Ajax_Url();
class wpmemory_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\wpmemory_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\wpmemory_BillMore\bill_install_plugin2');
    }
    ...
    public function bill_show_plugins()
    {
        ...
        $plugins_to_install[12]["Name"] = "Antibots Light";
        $plugins_to_install[12]["Description"] =
            "Anti Bots plugin. Beginner-Friendly Plugin: Easy-to-install bot blocker with a simple setup in just 3-4 clicks, ideal for beginners. Block SPAM bots and spiders. Avoid server overload and content steal";
        $plugins_to_install[12]["image"] =
            "https://ps.w.org/antibots/assets/icon-128x128.png?rev=2263326";
        $plugins_to_install[12]["slug"] = "antibots";
        ...
        $plugins_to_install[1]["Description"] =
            "Stop Bad Bots Advanced Plugin: Powerful bot blocker with extensive configuration options, designed for experienced users. Block SPAM bots and spiders. Avoid server overload and content steal";
...
?>
        <div style="padding-right:0px;">
            ...
            <table style="margin-right:0px; border-spacing: 0 25px; " class="widefat" cellspacing="0" id="bill_class_install-more-plugins-table">
...
$show_more_plugins = new wpmemory_Bill_show_more_plugins();
// } // end namespace
class wpmemory_PluginInstaller
{
    public function __construct()
    {
...
$plugin_installer = new wpmemory_PluginInstaller();
...
$quiet_skin = new wpmemory_bill_install_QuietSkin();
